...
const Chat = () => {
  ...
  const speakText = useCallback((text) => {
    ...
    if ("speechSynthesis" in window) {
      ...
      const spokenText = text.replace(/Sayraa/gi, "Sigh-raa").replace(/सायरा/gi, "साय-रा");
  ...
  useEffect(() => {
    const welcomeText = "Namaste mein hoon Sayraa, apki cute health assistant. Bol na, kya hua hai, bandhu? Aaj kya help karu? ...";
    ...
    <div className={styles.chatContainer}>
      ...
      <div 
        ...
        style={{
          ...
          backgroundSize: 'auto, min(320px, 70vw), cover'
        }}
      >
